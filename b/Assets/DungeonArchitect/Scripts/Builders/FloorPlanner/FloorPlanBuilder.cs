...
namespace DungeonArchitect.Builders.FloorPlan
{
    ...
    {
        public static readonly string MARKER_GROUND = "Ground";
        public static readonly string MARKER_CEILING = "Ceiling";
        public static readonly string MARKER_WALL = "Wall";
        public static readonly string MARKER_DOOR = "Door";
        public static readonly string MARKER_BUILDING_WALL = "BuildingWall";
    }
